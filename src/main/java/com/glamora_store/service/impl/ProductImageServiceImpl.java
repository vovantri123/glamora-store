...
public class ProductImageServiceImpl implements ProductImageService {
  ...
  @Override
  public PageResponse<ProductImageAdminResponse> getAllProductImages(Long productId, Long variantId,
                                                                     Pageable pageable) {
    Page<ProductImage> productImages;

    if (productId != null && variantId != null) {
      productImages = productImageRepository.findByProductIdAndVariantId(productId, variantId, pageable);
    } else if (productId != null) {
      productImages = productImageRepository.findByProductId(productId, pageable);
    } else if (variantId != null) {
      productImages = productImageRepository.findByVariantId(variantId, pageable);
    } else {
