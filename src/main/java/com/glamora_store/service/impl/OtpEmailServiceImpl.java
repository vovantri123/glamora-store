...
public class OtpEmailServiceImpl implements OtpEmailService {
    ...
    private void sendOtpEmail(String recipientEmail, String otpCode, OtpPurpose purpose) {
        try {
            ...
            //            String emailContent = "<div style=\"font-family:
            // Helvetica,Arial,sans-serif;overflow:auto;line-height:2\">"
            //                    + "<div style=\"margin:50px auto;width:70%;padding:20px 0\">"
            //                    + "<div style=\"border-bottom:1px solid #eee\">"
            //                    + "<a href=\"#\" style=\"font-size:1.4em;color:
            // #00466a;text-decoration:none;font-weight:600\">Glamora Store</a>"
            //                    + "</div>"
            //                    + "<p style=\"font-size:1.1em\">Hi,</p>"
            //                    + "<p>Thank you for choosing Glamora Store. Use the following OTP to "
            //                    + (purpose == OtpPurpose.REGISTER ? "complete your registration." : "reset your
            // password.")
            ...
            //                    + otpCode + "</h2>" + "<p style=\"font-size:0.9em;\">Regards,<br />Glamora Store
            // Team</p>"
            //                    + "<hr style=\"border:none;border-top:1px solid #eee\" />"
            //                    + "<div style=\"float:right;padding:8px
            // 0;color:#aaa;font-size:0.8em;line-height:1;font-weight:300\">"
            //                    + "<p>Glamora Inc</p>"
