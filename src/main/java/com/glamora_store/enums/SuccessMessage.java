...
public enum SuccessMessage {
  ...
  ACCESS_TOKEN_VALIDATION_SUCCESS("Access token validation success"),
  ACCESS_TOKEN_VALIDATION_FAILURE("Access token validation failure"),
  ...
  CREATE_PRODUCT_IMAGE_SUCCESS("Create product image successfully"),
  UPDATE_PRODUCT_IMAGE_SUCCESS("Update product image successfully"),
  DELETE_PRODUCT_IMAGE_SUCCESS("Delete product image successfully"),
  GET_PRODUCT_IMAGE_SUCCESS("Get product image successfully"),
  GET_ALL_PRODUCT_IMAGE_SUCCESS("Get all product images successfully"),
  // Product Variant messages
  CREATE_PRODUCT_VARIANT_SUCCESS("Create product variant successfully"),
  UPDATE_PRODUCT_VARIANT_SUCCESS("Update product variant successfully"),
  DELETE_PRODUCT_VARIANT_SUCCESS("Delete product variant successfully"),
  ACTIVATE_PRODUCT_VARIANT_SUCCESS("Activate product variant successfully"),
  GET_PRODUCT_VARIANT_SUCCESS("Get product variant successfully"),
  GET_ALL_PRODUCT_VARIANT_SUCCESS("Get all product variants successfully"),
