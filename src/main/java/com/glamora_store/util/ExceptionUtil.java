...
public class ExceptionUtil {
  ...
  public static ResponseStatusException with(
      HttpStatus status, ErrorCode errorCode, List<String> details) {
    return new ResponseStatusException(
        status, format(errorCode) + ": [" + String.join(", ", details) + "]");
  }

  public static ResponseStatusException with(
      HttpStatus status, ErrorCode errorCode, String details) {
